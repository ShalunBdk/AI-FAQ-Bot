...
- 🔀 **Автоматическое обнаружение** - когда несколько FAQ подходят одинаково хорошо
- ✅ **Выбор пользователя** - бот предлагает варианты с кнопками для выбора
- 📊 **Полное логирование** - отслеживание как показа вариантов, так и финального выбора
...
- **AI/ML**: ChromaDB, sentence-transformers (multilingual embeddings), pymorphy3 (лемматизация)
- **Database**: SQLite
